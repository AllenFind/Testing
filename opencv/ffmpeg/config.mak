...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-shared --disable-yasm
prefix=/usr/local
...
SRC_PATH="/Users/paiche/Documents/Testing/opencv/ffmpeg"
SRC_PATH_BARE=/Users/paiche/Documents/Testing/opencv/ffmpeg
BUILD_ROOT="/Users/paiche/Documents/Testing/opencv/ffmpeg"
CC_IDENT=Apple LLVM version 10.0.0 (clang-1000.10.44.4)
ARCH=x86
CC=gcc
...
CFLAGS=   -std=c99 -fomit-frame-pointer -fPIC -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -O3 -fno-math-errno -fno-signed-zeros -Qunused-arguments
ASFLAGS=   -fPIC -g
CC_O=-o $@
